<template>
  <div
    ...
    :style="{
      'max-height': (0 +
        (smallScreen ? (showHeader ? SECTION_HEIGHTS.smallScreenHeaderHeight : 0) : SECTION_HEIGHTS.normalScreenHeaderHeight) +
        (showSearch ? SECTION_HEIGHTS.searchHeight : 0)) + 'px',
...
const SECTION_HEIGHTS = {
  searchHeight: 70,
  smallScreenHeaderHeight: 286,
  normalScreenHeaderHeight: 200
}
